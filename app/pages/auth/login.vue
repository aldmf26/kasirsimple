    ...
    <div class="space-y-6">
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <NuxtLink to="/auth/forgot-password" class="text-xs text-primary-600 hover:underline">Lupa password?</NuxtLink>
          </div>
          <UInput
            id="password"
            v-model="password"
      ...
      <div class="border-t border-gray-200 pt-4 text-center">
        <p class="text-sm text-gray-600">
          Belum punya akun?
          <NuxtLink to="/auth/register" class="font-medium text-primary-600 hover:text-primary-500 hover:underline">
            Daftar Gratis
          </NuxtLink>
        </p>
      </div>
